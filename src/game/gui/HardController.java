...
public class HardController implements Initializable {
    ...
    @FXML
    public ImageView wall4;
    @FXML
    public ImageView wall5;
    ...
    @FXML
    public Label lane4lost;
    @FXML
    public Label lane5lost;
    ...
    @FXML
    public Label lane4dangerlevel;
    @FXML
    public Label lane5dangerlevel;
    @FXML
    ...
    @FXML
    public GridPane weaponSpace4;
    @FXML
    public GridPane weaponSpace5;
    ...
    @FXML
    public Rectangle laneLostBorder4;
    @FXML
    public Rectangle laneLostBorder5;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        lane4 = originalLanes.get(3);
        lane5 = originalLanes.get(4);
    ...
    public void setToHard() {
        allLanes = new Lane[] {lane1, lane2, lane3,lane4,lane5};
        allDangerLevels = new Label[] {lane1dangerlevel, lane2dangerlevel, lane3dangerlevel, lane4dangerlevel, lane5dangerlevel};
        allLostLabels = new Label[] {lane1lost, lane2lost, lane3lost, lane4lost, lane5lost};
        allHP = new Label[] {hp1, hp2, hp3, hp4, hp5};
        allHPBars = new ProgressBar[] {bar1, bar2, bar3, bar4, bar5};
        wallBaseHealth = lane1.getLaneWall().getBaseHealth();
        weaponShopLaneButtons = new Button[] {buy1, buy2, buy3, buy4, buy5};
        weaponSpaces = new GridPane[] {weaponSpace1, weaponSpace2, weaponSpace3, weaponSpace4, weaponSpace5};
        weaponCounts = new int[5][4];
        laneLostBorders = new Rectangle[] {laneLostBorder1, laneLostBorder2, laneLostBorder3, laneLostBorder4, laneLostBorder5};
        weaponCountLabels = new Label[5][4];
    }
    ...
    @FXML
    public void buyLane4(ActionEvent event) {
        if (weaponCode != 0) {
            completePurchase(weaponCode, lane4);
        }
    }
    @FXML
    public void buyLane5(ActionEvent event) {
        if (weaponCode != 0) {
            completePurchase(weaponCode, lane5);
        }
    }
